        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16 xl:gap-24">
          ...
          <div className="grid grid-cols-2 text-center gap-6 lg:gap-7">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="group relative flex flex-col items-center justify-center rounded-3xl border-2 border-[#1B3A6B]/20 bg-gradient-to-br from-[#ffffff] to-[#f5f9ff] px-6 py-8 shadow-[0_8px_32px_rgba(27,58,107,0.12)] transition-all duration-500 hover:shadow-[0_20px_50px_rgba(27,58,107,0.25)] hover:scale-105 md:px-8 md:py-10"
              >
                {/* Gradient background on hover */}
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-[#1B3A6B]/5 to-[#7B1B2A]/5 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
