...
const pathways = [
  {
    ...
    cards: [
      { tag: "Admissions", heading: "Admission Engine", detail: "Lead funnel, counseling, and conversion workflows." },
      { tag: "Branding", heading: "Campus Positioning", detail: "Digital-first branding for better visibility." },
      { tag: "Academic", heading: "Induction Programs", detail: "Structured onboarding and readiness modules." },
      { tag: "Placement", heading: "Placement Ops", detail: "Drive planning, recruiter outreach, and reporting." }
    ]
  },
  {
    id: "corporate",
    ...
    cards: [
      { tag: "Talent", heading: "Zero-Cost Hiring", detail: "Pre-vetted candidates aligned to role needs." },
      { tag: "L&D", heading: "Corporate Upskilling", detail: "Focused training tracks for business goals." },
      { tag: "Assessment", heading: "Skill Validation", detail: "Benchmarked evaluation for hiring confidence." },
      { tag: "Productivity", heading: "Role Enablement", detail: "Fast ramp-up frameworks for new hires." }
    ]
  },
  {
    id: "students",
    ...
    cards: [
      { tag: "Learning", heading: "Job-Ready Tracks", detail: "Industry-aligned curriculum with live practice." },
      { tag: "Mentorship", heading: "Expert Guidance", detail: "Weekly support and personalized roadmaps." },
      { tag: "Interview", heading: "Mock Rounds", detail: "Practical interview prep and performance feedback." },
      { tag: "Career", heading: "Placement Support", detail: "Resume, profile optimization, and recruiter connects." }
    ]
  }
];
...
function ConnectorArrow({ activeIndex, totalItems }) {
  ...
  return (
    <svg viewBox="0 0 240 420" className="h-[420px] w-full" aria-hidden>
      <line x1="4" y1={pathData.lineY} x2="34" y2={pathData.lineY} stroke="#8A63FF" strokeWidth="3" strokeLinecap="round" />
      <line x1="46" y1={pathData.lineY} x2="76" y2={pathData.lineY} stroke="#8A63FF" strokeWidth="3" strokeLinecap="round" />
      <path d={pathData.d} fill="none" stroke="#8A63FF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
      <path d={`M 232 ${pathData.arrowY} L 220 ${pathData.arrowY - 10} M 232 ${pathData.arrowY} L 220 ${pathData.arrowY + 10}`} fill="none" stroke="#8A63FF" strokeWidth="3" strokeLinecap="round" />
    </svg>
  );
}
              ...
              return (
                <button
                  ...
                  className={`flex h-[140px] w-full items-center gap-0 rounded-xl px-2 py-2 text-left text-4xl font-semibold transition md:text-6xl ${
                    isActive ? "text-[#211953]" : "text-[#b4b5c5] hover:text-[#9d9fb2]"
                  }`}
                >
                  <span className="mr-[24px] inline-flex w-auto items-center gap-[10px]" aria-hidden>
                    <span
                  ...
                  <span className={item.id === "corporate" ? "whitespace-nowrap" : ""}>
                    {item.label}
                  </span>
                </button>
              );
